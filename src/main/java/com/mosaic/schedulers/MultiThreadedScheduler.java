...
import com.mosaic.jobqueues.BlockingJobQueueWrapper;
import com.mosaic.jobqueues.JobQueue;
import com.mosaic.jobqueues.LinkedListJobQueue;
import com.mosaic.jobqueues.NotifyAllJobQueueWrapper;
import com.mosaic.jobqueues.PublicPrivateJobQueue;
import com.mosaic.jobqueues.StripedJobQueueFactory;
import com.mosaic.jobqueues.SynchronizedJobQueueWrapper;
...
public class MultiThreadedScheduler implements AsyncScheduler, AsyncSystem {
    ...
    public MultiThreadedScheduler( String name, int numNonBlockingThreads, int numBlockingThreads ) {
        assert numNonBlockingThreads >= 0;
        assert numBlockingThreads    >= 0;
