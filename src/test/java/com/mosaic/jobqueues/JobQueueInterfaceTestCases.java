...
import com.mosaic.schedulers.AsyncContext;
...
import static com.mosaic.jtunit.TestTools.assertSetEquals;
...
// todo givenEmptyJobQueue_bulkPop_expectChildToBeEmpty
    ...
    private void assertJobQueueContains( AsyncJob...expectedJobs ) {
        if ( guaranteesOrder ) {
            ...
            assertSetEquals( asSet( expectedJobs ), toSet( jobs.iterator() ) );
        }
...
//    @Test
    ...
    private <T> Set<T> toSet( Iterator<T> it ) {
        Set set = new HashSet();
