...
public class MultiThreadedSchedulerPerfTests {
    ...
    @Test
    public void throughputFixedThreadExecutor() throws InterruptedException {
        ExecutorService executor = Executors.newFixedThreadPool( 8 );

        perfTextExecutor(executor);
    }

    @Test   // 3 million
    public void throughputNewSingleExecutor() throws InterruptedException {
    ...
    @Test   // 1.8 million
    public void throughputNewCachedThreadPoolExecutor() throws InterruptedException {
        ExecutorService executor = Executors.newCachedThreadPool();

        perfTextExecutor( executor );
    }

    private void perfTextExecutor( ExecutorService executor ) {
        ProgressSheet[] progressSheets = setupProgressSheets( 20 );
        startReportingProgress( progressSheets );
